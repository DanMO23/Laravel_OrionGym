        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="fas fa-plus-circle"></i> Adicionar Novo Produto</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('produto.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="section-title mb-3">
                            <h5 class="text-primary"><i class="fas fa-info-circle"></i> Informações do Produto</h5>
                            <hr>
                        </div>

                        <div class="form-group">
                            <label for="nome" class="font-weight-bold">Nome do Produto <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="descricao" id="descricao" 
                                      ...
                                      rows="4" placeholder="Descreva o produto...">{{ old('descricao') }}</textarea>
                            @error('descricao')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="section-title mb-3 mt-4">
                            <h5 class="text-primary"><i class="fas fa-image"></i> Imagem do Produto</h5>
                            <hr>
                        </div>

                        <div class="form-group">
                            <label for="foto" class="font-weight-bold">Foto do Produto (PNG)</label>
                            ...
                            <small class="form-text text-muted">Formatos aceitos: PNG. Tamanho máximo: 2MB.</small>
                            @error('foto')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="valor" id="valor" 
                                               ...
                                               value="{{ old('valor') }}" step="0.01" required min="0">
                                        @error('valor')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>

...
@section('header-user', 'Cadastrar Funcionário')
            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-gradient-info text-white py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h4 class="mb-0 font-weight-bold">Cadastrar Funcionário</h4>
                            <small class="opacity-75">Preencha os dados do novo funcionário</small>
                        </div>
                    </div>
                </div>

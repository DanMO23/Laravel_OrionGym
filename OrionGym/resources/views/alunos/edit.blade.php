                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('alunos.update', $aluno->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $aluno->email }}" autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="data_nascimento" type="date" class="form-control @error('data_nascimento') is-invalid @enderror" name="data_nascimento" value="{{ $aluno->data_nascimento }}" required autocomplete="data_nascimento">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cpf" type="text" class="form-control @error('cpf') is-invalid @enderror" name="cpf" value="{{ $aluno->cpf }}" required autocomplete="cpf">
